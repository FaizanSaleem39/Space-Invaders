...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        rightEdge = topRightCornerInWorldSpace.x;
        ...
        leftEdge = bottomLeftCornerInWorldSpace.x;

        // Calculate the value of the player sprite's half-width
        playerSpriteWidth = playerSprite.bounds.size.x * 0.5f;
    }
    ...
    void Update()
    {
        ...
        float rightLimit = rightEdge - playerSpriteWidth;
        float leftLimit = leftEdge + playerSpriteWidth;
